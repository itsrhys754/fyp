...
// src/Repository/PetrolStationRepository.php
...
class PetrolStationRepository extends ServiceEntityRepository
{
    ...
    /**
     * Find stations along a route by filtering stations within a specified radius from each route point.
     *
     * @param array $coordinates Array of route points, each with latitude and longitude.
     * @param float $maxDistance Radius in kilometers around each point to include stations.
